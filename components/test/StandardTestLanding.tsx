...
export function StandardTestLanding({ test, insight }: { test: TestDefinition; insight: string }) {
    ...
    <div className="container-page py-10 sm:py-14">
      ...
      <section className="mx-auto max-w-3xl overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-card">
        ...
        <div className="p-6 sm:p-10">
          ...
          <ul className="mt-6 grid gap-2 text-sm text-slate-600 sm:grid-cols-3"><li>✓ 총 {itemCount}문항</li><li>✓ 4지선다 간편 응답</li><li>✓ 회원가입 없음</li></ul>
      ...
      <TestSeoContent test={test} itemCount={itemCount} answerType="4지선다" />
