  ...
  return (
    <div className="container-page py-10 sm:py-14"><Breadcrumbs items={[{ name: "서비스 소개" }]} />
      <div className="mx-auto max-w-3xl">
        <section className="rounded-3xl border border-slate-200 bg-white p-7 shadow-card sm:p-12"><span className="text-sm font-extrabold text-primary">ABOUT MIMI TEST</span><h1 className="mt-3 text-3xl font-black leading-tight tracking-tight text-ink sm:text-4xl">재미로 시작하고,<br />새로운 나를 발견해요.</h1><p className="mt-6 leading-8 text-slate-700">{siteConfig.name}는 성향, 재능, 직장생활, 연애관, 결혼관과 돈 관리 습관까지 다양한 관점으로 자신을 알아보는 종합 테스트 플랫폼입니다. 짧고 재미있지만 결과는 구체적이고 현실적인 테스트를 만드는 것을 중요하게 생각합니다.</p></section>
