...
export default async function TestDetailPage({ params, searchParams }: Props) {
  ...
  const answerType=test.type==="likert"||isBurnoutRisk?"5점 척도":isKkondaePower?"4지선다":"O/X";
