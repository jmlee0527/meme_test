...
export const consumerStyleTest:TestDefinition={
  type:"likert",slug:"consumer-style-test",title:"소비성향 테스트",shortTitle:"소비성향 테스트",cardTitle:"나의 소비성향은?",
  description:"평소 소비 습관과 가치관을 바탕으로 당신의 소비 성향을 분석합니다.",category: "직업.일상",duration:"약 2~3분",icon:"💳",thumbnail:"/tests/consumer-style.jpg",participants:3586,accent:"indigo",isNew:true,itemCount:consumerQuestions.length,questions:[],resultSlugs:consumerResultProfiles.map(({slug})=>slug),
  ...
  seoContent: {
    heading: "소비성향 테스트란?",
    paragraphs: [
      "소비성향 테스트는 돈을 쓰는 방식에 담긴 나만의 패턴을 확인하는 소비 습관 테스트입니다. 계획성, 충동성, 경험 선호, 미래 지향성, 품질 추구 5가지 기준으로 일상 속 소비 결정을 분석해 6가지 소비 유형 중 나와 가장 가까운 유형을 알려드립니다.",
      "단순히 돈을 많이 쓰는지 적게 쓰는지를 판단하는 테스트가 아닙니다. 같은 금액을 쓰더라도 어떤 사람은 경험에, 어떤 사람은 품질에, 어떤 사람은 미래를 위한 투자에 가치를 둡니다. 이 테스트는 무엇을 중요하게 여기며 어떤 상황에서 소비 결정이 달라지는지에 집중합니다.",
      "결과에서는 나의 소비 유형과 함께 강점, 주의하면 좋은 소비 습관, 유형에 맞는 돈 관리 방법을 안내합니다. 재테크를 시작하기 전에 자신의 돈 쓰는 성향을 이해하면 무리하지 않고 오래 지속할 수 있는 관리 방식을 찾는 데 도움이 됩니다.",
    ],
    faqs: [
      ["소비성향은 바뀔 수 있나요?", "네. 소득, 생활 환경, 가치관의 변화에 따라 소비 패턴도 달라집니다. 결과는 현재의 경향을 이해하기 위한 참고 정보입니다."],
      ["재테크 성향과도 관련이 있나요?", "관련이 있습니다. 계획성과 미래 지향성 점수가 높다면 저축·투자형 관리가, 경험 선호가 높다면 예산 안에서 즐기는 관리 방식이 잘 맞을 수 있습니다."],
      ["결과는 어떻게 활용하면 좋나요?", "자신의 소비 강점은 살리고 주의점은 보완하는 방향으로 활용해보세요. 커플이나 가족이 함께 하면 서로의 소비 가치관을 이해하는 데도 도움이 됩니다."],
    ],
    assesses: "소비 습관과 소비 가치관 유형",
  },
};
