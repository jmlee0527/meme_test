...
export const bigFiveTest: TestDefinition = {
  ...
  seoContent: {
    heading: "Big Five 성격 테스트란?",
    paragraphs: [
      "Big Five 성격 테스트는 현대 심리학에서 가장 널리 사용되는 성격 분석 모델 중 하나입니다. OCEAN 성격 테스트라고도 부르며, 사람을 하나의 고정된 유형으로 나누기보다 여러 성격 특성이 어느 정도로 나타나는지 연속적인 차원으로 살펴봅니다.",
      "OCEAN은 개방성(Openness), 성실성(Conscientiousness), 외향성(Extraversion), 친화성(Agreeableness), 정서 민감성(Neuroticism)의 앞 글자를 딴 이름입니다. 개방성은 새로운 경험과 아이디어에 대한 호기심, 성실성은 계획성과 책임감, 외향성은 사람과 활동에서 얻는 에너지, 친화성은 공감과 협력 성향, 정서 민감성은 감정 변화와 스트레스 신호에 대한 민감도를 의미합니다.",
      "미미테스트의 빅파이브 테스트는 25개의 일상 문항을 통해 5개 성격 차원을 0~100점으로 환산합니다. 결과에서는 레이더 차트와 함께 업무 스타일, 인간관계 스타일, 연애 스타일, 스트레스 반응 방식, 성장 포인트를 함께 제공합니다. 특정 점수가 높거나 낮다고 해서 좋고 나쁨을 판단하지 않고, 각 성향이 어떤 상황에서 강점이 되고 어떤 부분을 보완하면 좋은지 쉽게 이해할 수 있도록 구성했습니다.",
    ],
    faqs: [
      ["MBTI와 무엇이 다른가요?", "MBTI가 사람을 16가지 유형으로 분류한다면, Big Five는 5가지 성격 차원 각각의 점수를 연속적으로 보여줍니다. 학술 연구에서는 Big Five가 표준적인 성격 모델로 널리 쓰입니다."],
      ["정식 심리검사인가요?", "이 테스트는 Big Five 모델을 참고해 만든 자기이해용 콘텐츠로, 전문 기관의 정식 심리검사를 대체하지 않습니다."],
      ["정서 민감성이 높으면 나쁜 건가요?", "아니요. 정서 민감성이 높은 사람은 위험 신호와 타인의 감정을 빠르게 알아차리는 강점이 있습니다. 결과에서는 각 성향의 강점과 보완 포인트를 함께 안내합니다."],
    ],
    assesses: "OCEAN Big Five 성격 차원",
  },
};
