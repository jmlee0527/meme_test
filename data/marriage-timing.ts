...
export const marriageTimingTest: TestDefinition = {
  ...
  seoContent: {
    heading: "결혼 시기 테스트란?",
    paragraphs: [
      "결혼 시기 테스트는 “나는 언제 결혼할까?”가 궁금한 사람을 위한 무료 심리테스트입니다. 사주나 결혼운 풀이처럼 정해진 운명을 알려주는 것이 아니라, 결혼 의지, 현재 관계 상태, 경제적 준비도, 커리어 우선순위, 독립성 같은 현실적인 요소를 바탕으로 결혼 가능성이 자연스럽게 높아지는 시기를 예측합니다.",
      "현재 나이를 입력하고 12개의 질문에 답하면 6가지 결혼 시기 유형 중 나와 가장 가까운 결과가 나옵니다. 결과에서는 예상 결혼 시기와 함께 결혼을 앞당기는 요인과 늦추는 요인, 잘 맞는 파트너 유형, 지금부터 준비하면 좋은 것들을 안내합니다.",
      "결과는 예언이 아니라 현재의 선택 패턴을 보여주는 참고 정보입니다. 같은 사람이라도 관계 상태나 가치관이 달라지면 결과도 달라질 수 있으니, 연인이나 친구와 결과를 비교하며 결혼관에 대한 대화의 소재로 가볍게 활용해보세요.",
    ],
    faqs: [
      ["결과는 어떻게 계산되나요?", "결혼 의지, 관계 준비도, 경제적 준비, 커리어 우선순위, 독립성 등 성향 점수를 종합해 6가지 결혼 시기 유형 중 가장 가까운 결과와 예상 나이대를 계산합니다."],
      ["결혼운을 봐주는 건가요?", "아니요. 사주나 운세가 아닌 현재 성향 기반의 심리테스트이며, 재미와 자기 이해를 위한 참고용 콘텐츠입니다."],
      ["애인이 없어도 할 수 있나요?", "가능합니다. 현재 연애 여부는 여러 요소 중 하나일 뿐이며, 솔로도 자신의 결혼 성향과 준비도를 확인할 수 있습니다."],
      ["나이는 왜 입력하나요?", "현재 나이를 기준으로 예상 결혼 시기를 나이대로 안내하기 위해서만 사용되며, 서버에 저장되지 않습니다."],
    ],
    assesses: "결혼 의지와 준비도 등 결혼 관련 성향",
  },
};
