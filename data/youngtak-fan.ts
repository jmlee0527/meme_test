...
export const youngtakFanQuestions: YoungtakQuizQuestion[] = [
  ...
  q("youngtak_q032", "acting", "medium", "영탁이 ‘꼰대인턴’에서 특별 출연한 배역명으로 알려진 것은?", ["차형석", "오영탁", "강희식", "김준하"], 0, "영탁은 ‘꼰대인턴’에 차형석 역으로 특별 출연한 것으로 알려져 있습니다.", "kbs", "news", "방송/보도 자료 확인."),
